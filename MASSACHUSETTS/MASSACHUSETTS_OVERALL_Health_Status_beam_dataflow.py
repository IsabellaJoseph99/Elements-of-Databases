...
def run():         
    ...
    sql = 'SELECT SEQNO, _STATE, GENHLTH, PHYSHLTH, MENTHLTH FROM MASSACHUSETTS_cdc_modeled.MASSACHUSETTS_OVERALL_Health_Status '
    ...
    table_id = 'MASSACHUSETTS_OVERALL_Health_Status_Beam_DF' #assign only demographic table to table_id.
