...
def run():
     ...
     sql = 'SELECT SEQNO, _STATE, SMOKE100, SMOKDAY2, LASTSMK2, USENOW3 FROM MASSACHUSETTS_cdc_modeled.MASSACHUSETTS_TOBACCO_USE limit 50' #limit pipeline to the first 50 rows of the Demographics table
     ...
     table_id = 'MASSACHUSETTS_TOBACCO_USE_Beam' #assign only TOBACCO_USE table to table_id. 
