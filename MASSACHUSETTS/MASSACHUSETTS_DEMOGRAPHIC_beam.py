...
def run():
     ...
     sql = 'SELECT SEQNO, _STATE, SEX, MARITAL, EDUCA, EMPLOY, CHILDREN, INCOME2, WEIGHT2, HEIGHT3  FROM MASSACHUSETTS_cdc_modeled.MASSACHUSETTS_DEMOGRAPHIC limit 50' #limit pipeline to the first 50 rows of the Demographics table
     ...
     table_id = 'MASSACHUSETTS_DEMOGRAPHIC_Beam' #assign only demographic table to table_id. 
