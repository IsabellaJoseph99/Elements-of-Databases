...
def run():         
    ...
    sql = 'SELECT SEQNO, _STATE, SEX, MARITAL, EDUCA, EMPLOY, CHILDREN, INCOME2, WEIGHT2, HEIGHT3  FROM cdc_modeled.DEMOGRAPHIC'
    ...
    table_id = 'DEMOGRAPHIC_Beam_DF' #assign only demographic table to table_id.
