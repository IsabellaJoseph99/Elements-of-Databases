...
def run():
     ...
     sql = 'SELECT SEQNO, _STATE, GENHLTH, PHYSHLTH, MENTHLTH FROM cdc_modeled.OVERALL_Health_Status limit 50' #limit pipeline to the first 50 rows of the OVERALL_Health_Status table
     ...
     table_id = 'OVERALL_Health_Status_Beam' #assign only OVERALL_Health_Status table to table_id. 
