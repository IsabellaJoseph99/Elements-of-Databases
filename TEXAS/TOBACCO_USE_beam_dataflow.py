...
def run():         
    ...
    sql = 'SELECT SEQNO, _STATE, SMOKE100, SMOKDAY2, LASTSMK2, USENOW3 FROM cdc_modeled.TOBACCO_USE'
    ...
    table_id = 'TOBACCO_USE_Beam_DF' #assign only TOBACCO_USE table to table_id.
